...
public class ThirdPersonCamera : MonoBehaviour {
    ...
    [Tooltip("Lerp speed betwen Camera States")]
    public float smoothCameraRotation = 12f;
    [Tooltip("What layer will be culled")]
    public LayerMask cullingLayer = 1 << 0;
    [Tooltip("Debug purposes, lock the camera behind the character to better align the states")]
    ...
    /// <summary>
    /// Convert a point in the screen to a public Ray
    /// </summary>
    /// <param name="Point"></param>
    /// <returns></returns>
    public Ray ScreenToPointRay(Vector3 Point)
    {
    ...
    {
        // Set offset and pivot
    }

    public void ResetTargetOffsets()
    {
        //reset offset and pivot
    }
    ...
    void CameraMovement()
    {
        ...
        var targetPos = new Vector3(currentTarget.position.x, currentTarget.position.y + offsetPlayerPivot, currentTarget.position.z);      // TODO: Apply aiming offsets
        currentTargetPos = targetPos;
        desired_cPos = targetPos + new Vector3(0, height, 0);
        current_cPos = currentTargetPos + new Vector3(0, height, 0);
